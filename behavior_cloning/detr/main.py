...
def get_args_parser():
    ...
    parser.add_argument(
        "--dataset_dir", action="store", type=str, help="dataset_dir", required=False
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--rollout_path",
        type=str,
        help="absolute path of the rollout",
        default=None,
    )
    # parser.add_argument(
    #     "-f",
    ...
    #     "-m",
    #     "--mode",
    #     type=click.Choice(["record", "render", "playback", "recover", "policy"]),
    ...
    parser.add_argument(
        ...
        "--horizon",
        type=int,
        help="Rollout horizon, when mode is record",
        default=-1,
    )
    parser.add_argument(
        "-num_repeat",
    ...
    parser.add_argument(
        ...
        "--output_dir",
        type=str,
        default="/checkpoint/homanga/cactiv2/robohivelogs",
