...
class SPutItemInDrawer(Task):
    ...
    def init_task(self) -> None:
        ...
        self._item_0 = Shape("item0")
        self.register_graspable_objects([self._item, self._item_0] + self._drawers)
    ...
    def init_episode(self, index) -> List[str]:
        ...
        self._item_0.set_color(color_rgb)
        ...
        self.register_change_point_conditions(
            [
                ...
                DetectedCondition(self._item_0, self.negate, negated=True),
                CustomConditionSet(
                    [
                        DetectedCondition(self._item_0, success_sensor),
                        # NothingGrasped(self.robot.gripper),
                    ]
                ),
            ]
