...
class SLightBulbIn(Task):
    ...
    def init_task(self) -> None:
        ...
        self.success_bulb = ProximitySensor('success_bulb')
        self.negate = [ProximitySensor('negate0'), ProximitySensor('negate1')]
    ...
    def init_episode(self, index: int) -> List[str]:
        ...
        self.register_success_conditions([
            DetectedCondition(self.bulbs[index % 2], self.negate[index % 2], negated = True),
            DetectedCondition(self.bulbs[index % 2], self.success_bulb),
            DetectedCondition(self.bulbs[index % 2], ProximitySensor('success')),
